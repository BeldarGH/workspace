...
<div data-role="page" id="page" class="mobileCertlogonPageHeightStrech">
							  ...
							  <% } %>
													<table class="urLogonTable" cellSpacing="3px" cellPadding="0" valign="top">																									
														...
														<sap:if display="selfreg">											
															...
															<tr><td colspan="3" class="mobilePaddedTD mobileTDAlignTop">
														...
														<sap:if display="CertLogonLink">
															<tr><td colspan="3" class="mobilePaddedTDLarge mobileTDAlignTop">
																<sap:link type="userPasswordLogon" linkClass="mobileLink" textClass="mobileAdditionText" infoTextClass="mobileAdditionText"/>
															</td></tr>
														</sap:if>
														
														<sap:if display="UserPassword">												
														<!-- userid -->
														<tr>
															<td colspan="3">
																<!-- userid -->
														...
														<sap:if display="MapCertToUserConfirmation">
															<tr><td>
																<sap:label type="MapCertToUserConfirmation" styleClass="urLblStdNew"/>
															</td>
															<td>
																<sap:input type="MapCertToUserCheckBox"/>
															</td>
														</sap:if>	
														...
														<sap:if display="LogonHelpLink">
															<tr><td align="right" class="mobilePaddedTD mobileTDAlignBottom" colspan="3">
