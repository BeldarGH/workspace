...
if ( ("DeviceType.Smartphone".equalsIgnoreCase(DeviceType)) || ("DeviceType.Tablet".equalsIgnoreCase(DeviceType)) ) {
	...
	otherUiLoaded = true;
	uiFrameTopMargin = "margin-top:10px;";
%>
...
<div data-role="page" id="page">
	...
	<div data-role="content">
		<table id="tblFrmUI" valign="middle" dir="ltr"
			align="<%=uiFrameAllign%>" cellPadding="0" cellSpacing="0"
			style="<%=uiFrameTopMargin%>">
			<tr>
			<% if (isRTLMode) { %>
											...
											<sap:form type="saml2Return">
												<table class="urLogonTable" cellSpacing="3px" cellPadding="0" valign="top">
													...
													<tr>
														<td colspan="3">
														<!-- return button --> 
														<sap:button	type="saml2Return" styleClass="mobileButton mobileButtonGray mobileButtonExtraMarginTop" />
														</td>
													</tr>
												</table>
											</sap:form>
