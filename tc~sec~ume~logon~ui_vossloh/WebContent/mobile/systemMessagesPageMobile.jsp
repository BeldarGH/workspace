							...
							<table cellPadding="0" cellSpacing="0">
								<tr>
									<td valign="top" align="left">
										<div class="urSystemMessagesData">
											<!-- data table starts after this line -->
											<sap:form type="systemMessages">
												<table class="urSystemMessagesTable" cellSpacing="3px" cellPadding="0" valign="top">
													<!-- logout label -->
													<tr>
														<td width="100%">
															<div class="urSystemMessagesArea">
																<div class="mobile_urMsgBarErr mobileMsgMinHeight">
																	<sap:systemmsg styleClass="mobileErrorMessageText" />
																</div>
															</div>
														</td>
													</tr>
													<tr>
														<td width="100%">
															<!-- return button -->
															<sap:button	type="systemMessages" styleClass="mobileButton mobileButtonBlue" id="btnContinueId"/>
														</td>
													</tr>
												</table>
											</sap:form>
