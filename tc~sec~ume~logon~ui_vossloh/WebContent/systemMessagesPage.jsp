...
%>
<%@ include file="/mobile/systemMessagesPageMobile.jsp" %>
<% } %>
<% if(!otherUiLoaded){%>

<table id="tblFrmUI" width="790px" valign="middle" dir="ltr"
	align="<%=uiFrameAllign%>" cellPadding="0" cellSpacing="0"
	style="background-color:#ffffff;<%=uiFrameTopMargin%>">
	<% if(uiFrameVisible){ %>
	<tr>
		<td><img src="<%=webpath%>layout/lf_tl.png" width="29"
			height="32"></td>
		<td background="<%=webpath%>layout/lf_st.png"></td>
		<td><img src="<%=webpath%>layout/lf_tr.png" width="27"
			height="32"></td>
	</tr>
	<% } %>
	<tr>
		...
		<table id="tblInnerCnt" dir="rtl" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<table height="360px" cellPadding="0" cellSpacing="0">
						...
						<tr>
							...
							<div class="urSystemMessagesData"><!-- data table starts after this line -->
							<sap:form type="systemMessages">
								<table class="urSystemMessagesTable" cellSpacing="3px" cellPadding="0"
									valign="top">
									<!-- logout label -->
										<tr>
											<td width="80%">
											<div class="urSystemMessagesArea">
												<div class="urMsgBarErr">
													<sap:systemmsg styleClass="urTxtMsg"
														imageHeight="12"
														imageWidth="12" /></div>
												</div>
											</td>
									...
									<tr>
										<td align="right"><!-- return button --> <sap:button
											type="systemMessages" styleClass="urBtnStdNew" id="btnContinueId"/></td>
										<td>&nbsp;</td>
									</tr>
								</table>
						...
						<tr>
							...
							<div class="urCopyrightImage"><img
								src="<%=webpath%>layout/sap_logo.png"
			...
			<% if(uiFrameVisible){ %>
			<tr>
				<td><img src="<%=webpath%>layout/lf_bl.png" width="29"
					height="32"></td>
				<td align="center" background="<%=webpath%>layout/lf_sb.png"><span
					class="clip"><img src="<%=webpath%>layout/lf_clip.png"
					width="298" height="32"></span></td>
				<td><img src="<%=webpath%>layout/lf_br.png" width="27"
					height="32"></td>
			</tr>
			<% } %>
		</table>
...
<script type="text/javascript">
		function load() {
		    document.getElementById("btnContinueId").focus();
        }
</script>
