...
%>
<%@ include file="/mobile/errorPageMobile.jsp" %>
<% } %>
<% if (!otherUiLoaded) {%>
								...
								<table class="urLogonTable" cellSpacing="3px" cellPadding="0"
									...
									<tr>
										...
										<div class="urMessageArea">
											<sap:errormsg styleClass="urTxtMsg"
												imageClass="urMsgBarImgError" imageHeight="12"
												imageWidth="12" /></div>
										</td>
										<td width="20%">&nbsp;</td>
									</tr>
									<tr>
										<td align="left"><!-- return button --> <sap:button
											type="saml2Return" styleClass="urBtnStdNew" /></td>
										<td>&nbsp;</td>
										<td>&nbsp;</td>
									</tr>
								</table>
